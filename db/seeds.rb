...
pets = Pet.create!(name:"Molly",species:"cat",user:jade,info:"she really has a problem with birds")
pets = Pet.create!(name:"Oliver",species:"cat",user:jake,info:"great cat")
pets = Pet.create!(name:"Lily",species:"fish",user:jake,info:"very quiet")
...
pets = Pet.create!(name:"Ruby",species:"dog",user:ben,info:"the best dog in the world")
